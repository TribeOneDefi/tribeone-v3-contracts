...
// https://docs.tribeone.io/contracts/source/contracts/PerpsV2MarketViews
contract PerpsV2MarketViews is PerpsV2MarketBase, IPerpsV2MarketViews {
    ...
    /*
     * Sizes of the long and short sides of the market (in uUSD)
     */
     ...
     *  in uUSD fixed point decimal units or 0 if account is not liquidatable.
     */
     ...
     * @return fee in uUSD decimal, and invalid boolean flag for invalid rates or dynamic fee that is
