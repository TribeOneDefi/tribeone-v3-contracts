...
module.exports = async ({
	...
	// update all synths with 0 current rate, except uUSD
	const synthsRatesToUpdate = synths
		...
		.filter(({ name }) => name !== 'uUSD'); // SCCP-190: uUSD rate is 0 despite it being in forex category
	...
	await runStep({
		...
		comment: 'Set the minimum amount of time HAKA can be issued before any is burned (SIP-40)',
	});
	...
	await runStep({
		...
		comment: 'Set the gas limit for migrating escrowed HAKA to L2',
	});
