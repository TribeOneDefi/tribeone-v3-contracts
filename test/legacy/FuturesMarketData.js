...
contract('FuturesMarketData', accounts => {
	...
	before(async () => {
		...
		await uUSD.issue(trader1, traderInitialBalance);
		await uUSD.issue(trader2, traderInitialBalance);
		await uUSD.issue(trader3, traderInitialBalance);
