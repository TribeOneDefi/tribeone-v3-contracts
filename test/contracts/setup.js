...
const setupContract = async ({
	...
	const defaultArgs = {
		...
		Synth: [
			...
			tryGetProperty({ property: 'name', otherwise: 'Synthetic uUSD' }),
			tryGetProperty({ property: 'symbol', otherwise: 'uUSD' }),
			owner,
			tryGetProperty({ property: 'currencyKey', otherwise: toBytes32('uUSD') }),
