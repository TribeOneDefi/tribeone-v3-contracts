...
const defaults = {
	...
	HAKA_LIQUIDATION_PENALTY: w3utils.toWei('0.3'), // 30% penalty (used for HAKA Liquidations)
	SELF_LIQUIDATION_PENALTY: w3utils.toWei('0.2'), // 20% penalty
	FLAG_REWARD: w3utils.toWei('10'), // 10 HAKA
	LIQUIDATE_REWARD: w3utils.toWei('20'), // 20 HAKA
	...
	COLLATERAL_MANAGER: {
		...
		SHORTS: ['sBTC', 'sETH'],
		MAX_DEBT: w3utils.toWei('75000000'), // 75 million uUSD
	...
	FUTURES_MIN_KEEPER_FEE: w3utils.toWei('1'), // 1 uUSD min keeper fee
	FUTURES_MAX_KEEPER_FEE: w3utils.toWei('1000'), // 1000 uUSD min keeper fee
	...
	PERPSV2_KEEPER_LIQUIDATION_FEE: w3utils.toWei('2'), // 2 uUSD keeper liquidation fee (not flagger)
	// SIP-120
